...
page_title: "Resource hush_redis_access_credential - terraform-provider-hush"
subcategory: ""
description: |-
  Manage Redis dynamic access credentials in the Hush Security platform.
---

# Resource (hush_redis_access_credential)
...
resource "hush_redis_access_credential" "example" {
  name           = "prod-redis"
  description    = "Production Redis cache credential"
