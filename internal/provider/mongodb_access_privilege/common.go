...
const (
	idDesc          = "The unique identifier of the MongoDB access privilege"
	nameDesc        = "The name of the MongoDB access privilege"
	descriptionDesc = "The description of the MongoDB access privilege"
		...
		Elem: &schema.Resource{
			Schema: map[string]*schema.Schema{
				"privileges": {
					...
					Description: "The list of MongoDB privileges (e.g., find, insert, update, remove)",
				},
				"resource_type": {
					Type:         schema.TypeString,
					Required:     true,
			...
			Elem: &schema.Resource{
				Schema: map[string]*schema.Schema{
					"privileges": {
						...
						Description: "The list of MongoDB privileges",
					},
					"resource_type": {
						Type:        schema.TypeString,
						Computed:    true,
...
func expandGrants(list []any) []client.MongoDBGrant {
	grants := make([]client.MongoDBGrant, len(list))
	for i, v := range list {
		m := v.(map[string]any)
		grant := client.MongoDBGrant{
...
func flattenGrants(grants []client.MongoDBGrant) []any {
